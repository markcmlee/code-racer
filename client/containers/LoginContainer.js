...
const LoginContainer = () => {
  return (
    <section className="crt login">
      <div className="message">
        <h2 className="crtSpecial welcome">Welcome to</h2>
        <h3 className="crtSpecial title">CODERACER</h3>
        <div className="signIn">
          <a
            className="githubButton"
            href={
              "https://github.com/login/oauth/authorize?scope=read:user&client_id=ea720a623e0e14d358e4"
            }
          >
            <svg
